...
Exploratory data analysis of used car listings, looking at how price relates to a vehicle's age, brand, and mileage. Used this to learn, and along the way learned how to identify discrepancies and errors in CSV data sets.
...
- **Columns used**: brand, model, model_year, mileage, price, fuel_type, engine, transmission, accident, clean_title. (`ext_col` and `int_col` were dropped as they were not relevant to price analysis.)
